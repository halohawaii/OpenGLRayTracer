...
int main(int argc, char** argv)
{
    ...
    Material* whiteMetal = new Material(METAL, Vector3f(0.0f), Vector3f(1.0f, 1.0f, 1.0f));
    ...
    MeshTriangle ball1(rootPath + "models/cornellbox/ball1.obj", greenPlastic, true);
    ...
    MeshTriangle shortbox(rootPath + "models/cornellbox/shortbox.obj", whiteMetal);
